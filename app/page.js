    ...
    <main className="container lg:max-w-[768px] p-6 text-primary min-h-screen flex flex-col gap-20">
      <div className="flex flex-col gap-4 px-5">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-16">
          ...
          {/* Short-description */}
          <p>
            {` I'm a full-stack web developer with experience using React.js, Node.js, PostgreSQL and Ruby on Rails. Professionally, i develop feature with Java, SpringBoot, Angular.js, Typescript, and dive in CI/CD pipeline of Kubernetes, Docker, Jenkins.`}
          </p>
        </div>
      ...
      <div className="flex flex-col gap-4 px-5">
        ...
        <div className="flex flex-col gap-4 bg-primary-content p-3 rounded-xl">
          ...
          <Image alt='front-end-skills' src='https://skillicons.dev/icons?i=java,typescript,javascript,python,ruby' width={450} height={100} />
          <div className="flex flex-wrap gap-1">
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Java</span>
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Typescript</span>
        ...
        <div className="flex flex-col gap-4 bg-primary-content p-3 rounded-xl">
          ...
          <Image alt='front-end-skills' src='https://skillicons.dev/icons?i=html,css,bootstrap,react,next,tailwindcss,angular' width={750} height={100} />
          <div className="flex flex-wrap gap-1">
            ...
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Angular</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 bg-primary-content p-3 rounded-xl">
          ...
          <Image alt='front-end-skills' src='https://skillicons.dev/icons?i=nodejs,express,mongo,postgresql,prisma,jest,rails,spring,docker,kubernetes,jenkins' width={750} height={100} />
          <div className="flex flex-wrap gap-1">
            ...
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">SpringBoot</span>
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Docker</span>
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Kubernetes</span>
            <span className="px-3 py-0.5 rounded-3xl bg-primary text-primary-content">Jenkins</span>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center items-center gap-4 px-5">
        ...
        <p className="">
          {`
          I graduated in 2019 with a degree in Mechanical Engineering and worked in the field for four years. 
          I eventually realized that I had a stronger interest in software development, so I decided to make a career switch. 
          I’ve been teaching myself how to program, primarily through FreeCodeCamp and The Odin Project. 
          These online programs included many hands-on projects that helped me develop my skills and solidify my passion for web development. 
          I’m now eager to continue growing as a PERN stack developer by working on personal projects and seeking opportunities to advance my career in software engineering.
          `}
        </p>

        <p className="">
          {`
          Along my professional journey in software, I developed new features, integrating front-end UI lazily (optimized) with backend APIs. 
          Designed Java stateful service and solved multi-threaded concurrency challenges. 
          Worked with containerized java app deployment using Docker and Kubernetes. 
          Meanwhile, a clean code practitionist, who cares about code maintainability and scalability.
          Now, i'm a Certified React/Angular Developer, problem solver. :)
          `}
        </p>
